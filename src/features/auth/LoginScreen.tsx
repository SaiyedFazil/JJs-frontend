  ...
  return (
    ...
    >
      ...
      >
        ...
        <View className="h-[45%] w-full bg-primary items-center justify-center">
          <Animated.View entering={FadeInUp.duration(1000)} className="items-center">
             <View className="w-48 h-48 bg-primary-foreground/20 rounded-full items-center justify-center">
                <Text className="text-6xl">🍔</Text>
             </View>
             <Text className="text-primary-foreground text-3xl font-black mt-4">JJ's Kitchen</Text>
          </Animated.View>
        </View>
        ...
        <Animated.View 
          ...
          className="flex-1 bg-surface -mt-12 rounded-t-[40px] px-8 pt-10"
          style={[
            styles.cardShadow, 
        ...
        >
          <View className="items-center mb-10">
             ...
             <Text className="text-muted font-medium text-lg text-center">Let's start with your phone number</Text>
          </View>
          ...
          <View className="mb-8">
            <View className="flex-row gap-x-3 items-start">
              ...
              <View 
                ...
                className="w-20 h-16 rounded-2xl border-2 border-border bg-background items-center justify-center"
              >
                <Text className="text-xl font-bold text-foreground">+91</Text>
              </View>
              ...
              <View className="flex-1">
                <View 
                  style={[styles.inputBox, error ? styles.inputBoxError : null]}
                  className="h-16 rounded-2xl border-2 border-border bg-background px-4 justify-center"
                >
                  <TextInput 
                    ...
                    maxLength={10}
                    editable={!isLoading}
                    style={[styles.inputText, phone ? styles.fontLarge : styles.fontSmall]}
                    className="font-bold text-foreground h-full p-0"
                  />
                </View>
          ...
          <Button 
            ...
            className={`h-16 rounded-2xl shadow-lg ${isButtonActive ? 'bg-primary' : 'bg-primary/50 shadow-none'}`}
          >
            {isLoading ? (
              <View className="flex-row items-center justify-center">
                <Spinner color="white" size="sm" />
                <Text className="text-primary-foreground text-xl font-black ml-3">Sending OTP</Text>
              </View>
            ) : (
