...
import { View, Text, KeyboardAvoidingView, Platform, ScrollView, StyleSheet, Keyboard, TextInput, Dimensions, NativeModules } from 'react-native';
import Animated, { SlideInDown, FadeInUp, FadeIn, useSharedValue, useAnimatedStyle, withTiming } from 'react-native-reanimated';
...
export const LoginScreen = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try {
        const phoneNumber: string = await PhoneNumberHintModule.requestPhoneNumberHint();
        if (phoneNumber) {
